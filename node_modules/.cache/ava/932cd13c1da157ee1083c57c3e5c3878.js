  ...
  return _http2.default.get("http://javascriptplayground.com/test/", function (resp) {
    ...
    resp.on("end", function () {
      ...
      t.deepEqual(_rec._expr(_rec._capt(result, 'arguments/0'), {
        content: 't.deepEqual(result, data)',
        filepath: 'src/util/__tests__/apiCaller.spec.js',
        line: 45,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"result","range":[12,18]},{"type":"Identifier","name":"data","range":[20,24]}],"range":[0,25]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"result","range":[12,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"name"},"value":"data","range":[20,24]},{"type":{"label":")"},"range":[24,25]}]',
...
//   });
// });
//# sourceMappingURL=../../../node_modules/.cache/ava/932cd13c1da157ee1083c57c3e5c3878.js.map