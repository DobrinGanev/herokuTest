...
(0, _ava2.default)('method defaults to GET', function (t) {
  ...
  return callApi('hello', {}).then(function (data) {
    ...
    console.log(data);
    t.deepEqual(_rec._expr(_rec._capt([1, 2], 'arguments/0'), {
      content: 't.deepEqual([1, 2], [1, 2])',
      filepath: 'src/util/__tests__/apiCaller.spec.js',
      line: 41,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"ArrayExpression","elements":[{"type":"NumericLiteral","value":1,"range":[13,14]},{"type":"NumericLiteral","value":2,"range":[16,17]}],"range":[12,18]},{"type":"ArrayExpression","elements":[{"type":"NumericLiteral","value":1,"range":[21,22]},{"type":"NumericLiteral","value":2,"range":[24,25]}],"range":[20,26]}],"range":[0,27]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"["},"range":[12,13]},{"type":{"label":"num"},"value":1,"range":[13,14]},{"type":{"label":","},"range":[14,15]},{"type":{"label":"num"},"value":2,"range":[16,17]},{"type":{"label":"]"},"range":[17,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"["},"range":[20,21]},{"type":{"label":"num"},"value":1,"range":[21,22]},{"type":{"label":","},"range":[22,23]},{"type":{"label":"num"},"value":2,"range":[24,25]},{"type":{"label":"]"},"range":[25,26]},{"type":{"label":")"},"range":[26,27]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec2._expr(_rec2._capt([1, 2], 'arguments/1'), {
      content: 't.deepEqual([1, 2], [1, 2])',
      filepath: 'src/util/__tests__/apiCaller.spec.js',
      line: 41,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"ArrayExpression","elements":[{"type":"NumericLiteral","value":1,"range":[13,14]},{"type":"NumericLiteral","value":2,"range":[16,17]}],"range":[12,18]},{"type":"ArrayExpression","elements":[{"type":"NumericLiteral","value":1,"range":[21,22]},{"type":"NumericLiteral","value":2,"range":[24,25]}],"range":[20,26]}],"range":[0,27]}',
...
//   });
// });
//# sourceMappingURL=../../../node_modules/.cache/ava/ef0d816090dbddad9ecab3a78615f21a.js.map