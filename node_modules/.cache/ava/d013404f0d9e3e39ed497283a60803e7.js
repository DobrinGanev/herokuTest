...
(0, _ava2.default)('method defaults to GET', function (t) {
  var reply = { foo: 'bar' };
  (0, _nock2.default)(API_URL).get('/foo').reply(200, reply);
  return callApi('foo').then(function (response) {
...
//# sourceMappingURL=../../../node_modules/.cache/ava/d013404f0d9e3e39ed497283a60803e7.js.map