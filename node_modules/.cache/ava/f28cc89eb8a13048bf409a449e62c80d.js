...
(0, _ava2.default)('method defaults to GET', function (t) {
  var reply = { 200: 'This is the HTML for the homepage' };
  (0, _nock2.default)('http://localhost:8000').get('/hello').reply(200, 'This is the HTML for the homepage');
  return callApi('https://davidwalsh.name').then(function (response) {
...
//# sourceMappingURL=../../../node_modules/.cache/ava/f28cc89eb8a13048bf409a449e62c80d.js.map