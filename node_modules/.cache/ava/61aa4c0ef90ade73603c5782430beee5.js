...
(0, _ava2.default)('has a .Foo class name', function (t) {
  var _rec = new _powerAssertRecorder();

  var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(Bar, null));
  t.true(_rec._expr(_rec._capt(_rec._capt(wrapper, 'arguments/0/callee/object').hasClass('Bar'), 'arguments/0'), {
    content: 't.true(wrapper.hasClass(\'Bar\'))',
    filepath: 'src/components/__tests__/Bar.spec.js',
    line: 11,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"wrapper","range":[7,14]},"property":{"type":"Identifier","name":"hasClass","range":[15,23]},"computed":false,"range":[7,23]},"arguments":[{"type":"StringLiteral","value":"Bar","range":[24,29]}],"range":[7,30]}],"range":[0,31]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"wrapper","range":[7,14]},{"type":{"label":"."},"range":[14,15]},{"type":{"label":"name"},"value":"hasClass","range":[15,23]},{"type":{"label":"("},"range":[23,24]},{"type":{"label":"string"},"value":"Bar","range":[24,29]},{"type":{"label":")"},"range":[29,30]},{"type":{"label":")"},"range":[30,31]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
});
//# sourceMappingURL=../../../node_modules/.cache/ava/61aa4c0ef90ade73603c5782430beee5.js.map