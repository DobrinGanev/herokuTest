...
(0, _ava2.default)('method defaults to GET', function (t) {
  var reply = { message: "message hello world from server" };
  (0, _nock2.default)('http://localhost:8000').get('/hello').reply(200, 'This is the HTML for the homepage');
  return callApi('hello', {}).then(function (data) {
    var _rec = new _powerAssertRecorder(),
        _rec2 = new _powerAssertRecorder();

    console.log(data);
    t.deepEqual(_rec._expr(_rec._capt(data, 'arguments/0'), {
      content: 't.deepEqual(data, reply)',
      filepath: 'src/util/__tests__/apiCaller.spec.js',
      line: 41,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"data","range":[12,16]},{"type":"Identifier","name":"reply","range":[18,23]}],"range":[0,24]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"data","range":[12,16]},{"type":{"label":","},"range":[16,17]},{"type":{"label":"name"},"value":"reply","range":[18,23]},{"type":{"label":")"},"range":[23,24]}]',
...
(0, _ava2.default)('sends the body', function (t) {
  var body = { id: 5 };
  var reply = { foo: 'bar' };
  (0, _nock2.default)(API_URL).post('/foo', body).reply(200, reply);
  return callApi('foo', 'post', body).then(function (response) {
...
(0, _ava2.default)('returns the error', function (t) {
  ...
  (0, _nock2.default)(API_URL).get('/send_error').reply(500, reply);
  return callApi('send_error').then(function (error) {
...
//# sourceMappingURL=../../../node_modules/.cache/ava/cf0d7cef92b668fa42de9f2f558b4d19.js.map