  ...
  return _http2.default.get("http://javascriptplayground.com/test/", function (resp) {
    ...
    resp.on("end", function () {
      ...
      t.deepEqual(_rec._expr(_rec._capt(result, 'arguments/0'), {
        content: 't.deepEqual(result, str)',
        filepath: 'src/util/__tests__/apiCaller.spec.js',
        line: 45,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"result","range":[12,18]},{"type":"Identifier","name":"str","range":[20,23]}],"range":[0,24]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"result","range":[12,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"name"},"value":"str","range":[20,23]},{"type":{"label":")"},"range":[23,24]}]',
        visitorKeys: _powerAssertVisitorKeys
      }), _rec2._expr(_rec2._capt(str, 'arguments/1'), {
        content: 't.deepEqual(result, str)',
        filepath: 'src/util/__tests__/apiCaller.spec.js',
        line: 45,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"result","range":[12,18]},{"type":"Identifier","name":"str","range":[20,23]}],"range":[0,24]}',
...
//   });
// });
//# sourceMappingURL=../../../node_modules/.cache/ava/242302b6e8a6fdf3b1192e4c37fec0dd.js.map