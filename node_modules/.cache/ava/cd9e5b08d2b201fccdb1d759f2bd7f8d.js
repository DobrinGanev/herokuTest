...
var _httpMytestCom = "http://mytest.com";
var API_URL = _httpMytestCom.API_URL;
...
(0, _ava2.default)('method defaults to GET', function (t) {
  ...
  (0, _nock2.default)(API_URL).get("/test").reply(200, reply);
  return callApi('test').then(function (response) {
...
//# sourceMappingURL=../../../node_modules/.cache/ava/cd9e5b08d2b201fccdb1d759f2bd7f8d.js.map