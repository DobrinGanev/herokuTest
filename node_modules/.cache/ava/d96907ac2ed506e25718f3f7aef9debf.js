...
(0, _ava2.default)('method defaults to GET', function (t) {
  var reply = "hello world from server";

  (0, _nock2.default)('http://localhost:8000').get('/helloTest/').reply(200, "hello world from server");

  return callApi('helloTest', {}).then(function (result) {
    var _rec = new _powerAssertRecorder(),
        _rec2 = new _powerAssertRecorder();

    t.deepEqual(_rec._expr(_rec._capt(result, 'arguments/0'), {
      content: 't.deepEqual(result, reply)',
      filepath: 'src/util/__tests__/apiCaller.spec.js',
      line: 39,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"result","range":[12,18]},{"type":"Identifier","name":"reply","range":[20,25]}],"range":[0,26]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"result","range":[12,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"name"},"value":"reply","range":[20,25]},{"type":{"label":")"},"range":[25,26]}]',
...
//   });
// });
//# sourceMappingURL=../../../node_modules/.cache/ava/d96907ac2ed506e25718f3f7aef9debf.js.map