...
(0, _ava2.default)('method defaults to GET', function (t) {
  ...
  return callApi('hello', {}).then(function (data) {
    ...
    t.deepEqual(_rec._expr(_rec._capt(response, 'arguments/0'), {
      content: 't.deepEqual(response, data)',
      filepath: 'src/util/__tests__/apiCaller.spec.js',
      line: 40,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"response","range":[12,20]},{"type":"Identifier","name":"data","range":[22,26]}],"range":[0,27]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"response","range":[12,20]},{"type":{"label":","},"range":[20,21]},{"type":{"label":"name"},"value":"data","range":[22,26]},{"type":{"label":")"},"range":[26,27]}]',
...
//# sourceMappingURL=../../../node_modules/.cache/ava/9d30ce7438c8713dfaa8b5cb35945157.js.map