...
(0, _ava2.default)('method defaults to GET', function (t) {
  ...
  (0, _nock2.default)('http://localhost:8000').get('/hello').reply(200, data);
  return callApi('hello', {}).then(function (replay) {
    var _rec = new _powerAssertRecorder(),
        _rec2 = new _powerAssertRecorder();

    console.log(data);
    t.deepEqual(_rec._expr(_rec._capt(replay, 'arguments/0'), {
      content: 't.deepEqual(replay, data)',
      filepath: 'src/util/__tests__/apiCaller.spec.js',
      line: 41,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"replay","range":[12,18]},{"type":"Identifier","name":"data","range":[20,24]}],"range":[0,25]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"replay","range":[12,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"name"},"value":"data","range":[20,24]},{"type":{"label":")"},"range":[24,25]}]',
...
//   });
// });
//# sourceMappingURL=../../../node_modules/.cache/ava/f6fc3f300a50333d54ed3c5f4b9e7b59.js.map