...
(0, _ava2.default)('method defaults to GET', function (t) {
  ...
  return callApi('hello').then(function (response) {
...
(0, _ava2.default)('returns the error', function (t) {
  ...
  return callApi('send_error').then(function (error) {
    ...
    t.deepEqual(_rec3._expr(_rec3._capt(error, 'arguments/0'), {
...
//# sourceMappingURL=../../../node_modules/.cache/ava/6a18094f0d0ce5f1fcaf6b981d58a015.js.map