...
(0, _ava2.default)('method defaults to GET', function (t) {
  ...
  return callApi({}).then(function (result) {
    ...
    t.deepEqual(_rec._expr(_rec._capt(reply, 'arguments/0'), {
      content: 't.deepEqual(reply, result)',
      filepath: 'src/util/__tests__/apiCaller.spec.js',
      line: 35,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"reply","range":[12,17]},{"type":"Identifier","name":"result","range":[19,25]}],"range":[0,26]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"reply","range":[12,17]},{"type":{"label":","},"range":[17,18]},{"type":{"label":"name"},"value":"result","range":[19,25]},{"type":{"label":")"},"range":[25,26]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec2._expr(_rec2._capt(result, 'arguments/1'), {
      content: 't.deepEqual(reply, result)',
      filepath: 'src/util/__tests__/apiCaller.spec.js',
      line: 35,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"reply","range":[12,17]},{"type":"Identifier","name":"result","range":[19,25]}],"range":[0,26]}',
...
//   });
// });
//# sourceMappingURL=../../../node_modules/.cache/ava/f88fb1cec5b9a130af0598404f3e7715.js.map