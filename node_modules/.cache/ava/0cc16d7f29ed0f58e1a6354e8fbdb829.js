...
(0, _ava2.default)('method defaults to GET', function (t) {
  ...
  (0, _nock2.default)('http://localhost:8000').get('/hello').reply(200, reply);
  return callApi('hello', {}).then(function (data) {
    ...
    t.deepEqual(_rec._expr(_rec._capt(messages, 'arguments/0'), {
      content: 't.deepEqual(messages, reply)',
      filepath: 'src/util/__tests__/apiCaller.spec.js',
      line: 42,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"messages","range":[12,20]},{"type":"Identifier","name":"reply","range":[22,27]}],"range":[0,28]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"messages","range":[12,20]},{"type":{"label":","},"range":[20,21]},{"type":{"label":"name"},"value":"reply","range":[22,27]},{"type":{"label":")"},"range":[27,28]}]',
...
//# sourceMappingURL=../../../node_modules/.cache/ava/0cc16d7f29ed0f58e1a6354e8fbdb829.js.map