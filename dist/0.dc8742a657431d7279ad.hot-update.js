...
/***/ function(module, exports, __webpack_require__) {
	...
	function helloWorld() {
		return function (dispatch) {
			return (0, _isomorphicFetch2.default)("").then(function (response) {
				return response.json();
			}).then(function (body) {}).catch(function (error) {
				console.error(error);
			});
		};
	}
...
//# sourceMappingURL=0.dc8742a657431d7279ad.hot-update.js.map